// content/widget.js — SW Profit v0.4.0
// Правки v0.3.5:
...
(() => {
  'use strict';
  const VERSION = '0.4.0';
  const API_TARIFFS = 'https://swprofit.ru/api/wb-tariffs';
  const API_CARD = 'https://card.wb.ru/cards/v4/detail';
  const DASHBOARD_URL = 'https://swprofit.ru/dashboard.html';
  const HOST_ID = 'swprofit-host-v040';
